...
def generate_multiple_spirals(saving_dir, theta_max, totalpoints=300, spirals_number=4, max_noise=0,
                              save_results_in_text_file=True, save_plot=True, show_plot=False):
