...
for index3, theta_max in enumerate(theta_maxes):
    ...
    for index4, max_noise in enumerate(max_noises):  # to be done 0, 0.1, 0.2,
        ...
        generate_multiple_spirals(work_dir, theta_max, totalpoints=300, spirals_number=4,
                                 max_noise=max_noise, save_results_in_text_file=True, save_plot=True, show_plot=False)
